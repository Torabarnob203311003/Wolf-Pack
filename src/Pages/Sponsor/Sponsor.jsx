      ...
      <div className="bg-gradient-to-br from-[#a8820f] to-[#E7B20E] py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-black/80 text-lg max-w-3xl mx-auto">
            This platform is proudly supported by forward-thinking companies and
            dedicated players who believe in the future of competitive gaming
