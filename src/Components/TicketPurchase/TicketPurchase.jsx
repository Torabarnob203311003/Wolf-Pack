...
//                     <button onClick={handleBuyTickets} className="px-6 py-2 bg-yellow-500 hover:bg-yellow-600 text-black font-bold rounded-lg transition-colors text-sm sm:text-base">
//                         GET LUCKY DIP
//                     </button>
//                 </div>
...
const TicketPurchaseSection = ({ ticketPrice = 30, maxTickets = 50, raffle, userId }) => {
