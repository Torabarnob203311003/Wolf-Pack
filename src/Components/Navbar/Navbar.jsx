          ...
          {user && isAuthenticated ? (
            ...
            <>
              <button
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #C78800 0%, #F5D334 17.79%, #EDC933 27.88%, #D9AD30 45.29%, #D4A52F 49.38%, #F0CC33 70.61%, #F5D334 74.22%, #ECC92F 78.35%, #D5AC22 85.48%, #AE7F0D 94.71%, #966200 100%)",
                  padding: "2px",
                }}
              >
                <span
